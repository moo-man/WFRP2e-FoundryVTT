 ...
 *
 * ActorSheetWfrp2eNPC is assigned to NPC type actors, and the specific interactions
 ...
 * 
 */
class ActorSheetWfrp2eNPC extends ActorSheetWfrp2e
{
  static get defaultOptions()
  {
    ...
    mergeObject(options,
    {
      classes: options.classes.concat(["wfrp2e", "actor", "npc-sheet"]),
      width: 610,
      height: 740,
    });
    return options;
  ...
  get template()
  {
    ...
    return "systems/wfrp2e/templates/actors/npc-sheet.html";
  }
...
// Register NPC Sheet
Actors.registerSheet("wfrp2e", ActorSheetWfrp2eNPC,
{
  types: ["npc"],
  makeDefault: true
});