 ...
 *
 * ActorSheetWfrp2eCreature is assigned to Creature type actors, which have a very 
 ...
 * 
 */
class ActorSheetWfrp2eCreature extends ActorSheetWfrp2e
{
  static get defaultOptions()
  {
    ...
    mergeObject(options,
    {
      classes: options.classes.concat(["wfrp2e", "actor", "creature-sheet"]),
      width: 610,
      height: 740,
    });
    return options;
  ...
  get template()
  {
    ...
    return "systems/wfrp2e/templates/actors/creature-sheet.html";
  }
  ...
  _onTraitClick(traitId, include)
  {
    ...
    let bonuses = WFRP2E.traitBonuses[trait.name.toLowerCase()]
...
Actors.registerSheet("wfrp2e", ActorSheetWfrp2eCreature,
{
  types: ["creature"],
  makeDefault: true
});