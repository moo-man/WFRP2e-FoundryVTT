...
Hooks.on("ready", async () => {
    ...
    // Localize strings in the WFRP2E object
    for (let obj in WFRP2E)
    {
      for (let el in WFRP2E[obj])
      {
        if (typeof WFRP2E[obj][el] === "string")
        {
          WFRP2E[obj][el] = game.i18n.localize(WFRP2E[obj][el])
        }
      }
    }
...
Combat.prototype._getInitiativeFormula = function(combatant) {
  ...
  let initiativeSetting = game.settings.get("wfrp2e", "initiativeRule")
...
// Socket Responses - Morrslieb and opposed tests
 ...
 try 
 {
  needMigration = !isNewerVersion(game.settings.get("wfrp2e", "systemMigrationVersion"), NEEDS_MIGRATION_VERSION)
 }
 catch 
 {
  needMigration = true;
...
Hooks.on("closePermissionConfig", () => {
  ...
  {
      ui.notifications.warn("WARNING: WFRP2E currently requires users to have \"Browse File Explorer\" Permission", {permanent: true})
      return
  }
})
...
Hooks.once('diceSoNiceReady', (dice3d) => {
  ...
  dice3d.addDicePreset({
    type:"d10",
    labels:[
      'systems/wfrp2e/ui/dices/black/d10-1.png', 
      'systems/wfrp2e/ui/dices/black/d10-2.png', 
      'systems/wfrp2e/ui/dices/black/d10-3.png', 
      'systems/wfrp2e/ui/dices/black/d10-4.png', 
      'systems/wfrp2e/ui/dices/black/d10-5.png', 
      'systems/wfrp2e/ui/dices/black/d10-6.png', 
      'systems/wfrp2e/ui/dices/black/d10-7.png', 
      'systems/wfrp2e/ui/dices/black/d10-8.png', 
      'systems/wfrp2e/ui/dices/black/d10-9.png', 
      'systems/wfrp2e/ui/dices/black/d10-0.png'
    ],
    bumpMaps:[
      'systems/wfrp2e/ui/dices/normals/d10-1.jpg', 
      'systems/wfrp2e/ui/dices/normals/d10-2.jpg', 
      'systems/wfrp2e/ui/dices/normals/d10-3.jpg', 
      'systems/wfrp2e/ui/dices/normals/d10-4.jpg', 
      'systems/wfrp2e/ui/dices/normals/d10-5.jpg', 
      'systems/wfrp2e/ui/dices/normals/d10-6.jpg', 
      'systems/wfrp2e/ui/dices/normals/d10-7.jpg', 
      'systems/wfrp2e/ui/dices/normals/d10-8.jpg', 
      'systems/wfrp2e/ui/dices/normals/d10-9.jpg', 
      'systems/wfrp2e/ui/dices/normals/d10-0.jpg'
    ],
    system:"wfrp-black"
  });
  ...
  dice3d.addDicePreset({
    type:"d10",
    labels:[
      'systems/wfrp2e/ui/dices/white/d10-1.png', 
      'systems/wfrp2e/ui/dices/white/d10-2.png', 
      'systems/wfrp2e/ui/dices/white/d10-3.png', 
      'systems/wfrp2e/ui/dices/white/d10-4.png', 
      'systems/wfrp2e/ui/dices/white/d10-5.png', 
      'systems/wfrp2e/ui/dices/white/d10-6.png', 
      'systems/wfrp2e/ui/dices/white/d10-7.png', 
      'systems/wfrp2e/ui/dices/white/d10-8.png', 
      'systems/wfrp2e/ui/dices/white/d10-9.png', 
      'systems/wfrp2e/ui/dices/white/d10-0.png'
    ],
    bumpMaps:[
      'systems/wfrp2e/ui/dices/normals/d10-1.jpg', 
      'systems/wfrp2e/ui/dices/normals/d10-2.jpg', 
  ...
  dice3d.addDicePreset({
    type:"d10",
    labels:[
      'systems/wfrp2e/ui/dices/red/d10-1.png', 
      'systems/wfrp2e/ui/dices/red/d10-2.png', 
      'systems/wfrp2e/ui/dices/red/d10-3.png', 
      'systems/wfrp2e/ui/dices/red/d10-4.png', 
      'systems/wfrp2e/ui/dices/red/d10-5.png', 
      'systems/wfrp2e/ui/dices/red/d10-6.png', 
      'systems/wfrp2e/ui/dices/red/d10-7.png', 
      'systems/wfrp2e/ui/dices/red/d10-8.png', 
      'systems/wfrp2e/ui/dices/red/d10-9.png', 
      'systems/wfrp2e/ui/dices/red/d10-0.png'
    ],
    bumpMaps:[
      'systems/wfrp2e/ui/dices/normals/d10-1.jpg', 
      'systems/wfrp2e/ui/dices/normals/d10-2.jpg', 
  ...
  dice3d.addDicePreset({
    type:"d100",
    labels:[
      'systems/wfrp2e/ui/dices/black/d100-10.png', 
      'systems/wfrp2e/ui/dices/black/d100-20.png', 
      'systems/wfrp2e/ui/dices/black/d100-30.png', 
      'systems/wfrp2e/ui/dices/black/d100-40.png', 
      'systems/wfrp2e/ui/dices/black/d100-50.png', 
      'systems/wfrp2e/ui/dices/black/d100-60.png', 
      'systems/wfrp2e/ui/dices/black/d100-70.png', 
      'systems/wfrp2e/ui/dices/black/d100-80.png', 
      'systems/wfrp2e/ui/dices/black/d100-90.png', 
      'systems/wfrp2e/ui/dices/black/d100-00.png'
    ],
    bumpMaps:[
      'systems/wfrp2e/ui/dices/normals/d100-10.jpg', 
      'systems/wfrp2e/ui/dices/normals/d100-20.jpg', 
      'systems/wfrp2e/ui/dices/normals/d100-30.jpg', 
      'systems/wfrp2e/ui/dices/normals/d100-40.jpg', 
      'systems/wfrp2e/ui/dices/normals/d100-50.jpg', 
      'systems/wfrp2e/ui/dices/normals/d100-60.jpg', 
      'systems/wfrp2e/ui/dices/normals/d100-70.jpg', 
      'systems/wfrp2e/ui/dices/normals/d100-80.jpg', 
      'systems/wfrp2e/ui/dices/normals/d100-90.jpg', 
      'systems/wfrp2e/ui/dices/normals/d100-00.jpg'
    ],
    system:"wfrp-black"
  });
  ...
  dice3d.addDicePreset({
    type:"d100",
    labels:[
      'systems/wfrp2e/ui/dices/white/d100-10.png', 
      'systems/wfrp2e/ui/dices/white/d100-20.png', 
      'systems/wfrp2e/ui/dices/white/d100-30.png', 
      'systems/wfrp2e/ui/dices/white/d100-40.png', 
      'systems/wfrp2e/ui/dices/white/d100-50.png', 
      'systems/wfrp2e/ui/dices/white/d100-60.png', 
      'systems/wfrp2e/ui/dices/white/d100-70.png', 
      'systems/wfrp2e/ui/dices/white/d100-80.png', 
      'systems/wfrp2e/ui/dices/white/d100-90.png', 
      'systems/wfrp2e/ui/dices/white/d100-00.png'
    ],
    bumpMaps:[
      'systems/wfrp2e/ui/dices/normals/d100-10.jpg', 
      'systems/wfrp2e/ui/dices/normals/d100-20.jpg', 
  ...
  dice3d.addDicePreset({
    type:"d100",
    labels:[
      'systems/wfrp2e/ui/dices/red/d100-10.png', 
      'systems/wfrp2e/ui/dices/red/d100-20.png', 
      'systems/wfrp2e/ui/dices/red/d100-30.png', 
      'systems/wfrp2e/ui/dices/red/d100-40.png', 
      'systems/wfrp2e/ui/dices/red/d100-50.png', 
      'systems/wfrp2e/ui/dices/red/d100-60.png', 
      'systems/wfrp2e/ui/dices/red/d100-70.png', 
      'systems/wfrp2e/ui/dices/red/d100-80.png', 
      'systems/wfrp2e/ui/dices/red/d100-90.png', 
      'systems/wfrp2e/ui/dices/red/d100-00.png'
    ],
    bumpMaps:[
      'systems/wfrp2e/ui/dices/normals/d100-10.jpg', 
      'systems/wfrp2e/ui/dices/normals/d100-20.jpg', 
