...
Hooks.once("init", () => {
    ...
    FilePicker.browse("data", "systems/wfrp2e/tables").then(resp => {
      try 
      {
      if (resp.error)
        throw ""
    ...
    game.settings.register("wfrp2e", "criticalsFumblesOnAllTests", {
      ...
      game.settings.register("wfrp2e", "testAutoFill", {
      ...
      game.settings.register("wfrp2e", "npcSpeciesCharacteristics", {
      ...
      // Register Advantage cap
      game.settings.register("wfrp2e", "soundEffects", {
    ...
    // Pre-load templates
    loadTemplates([
      "systems/wfrp2e/templates/actors/actor-attributes.html",
      "systems/wfrp2e/templates/actors/actor-abilities.html",
      "systems/wfrp2e/templates/actors/actor-main.html",
      ...
      "systems/wfrp2e/templates/actors/actor-classes.html",
      "systems/wfrp2e/templates/actors/actor-notes.html",
      "systems/wfrp2e/templates/actors/npc-main.html",
      "systems/wfrp2e/templates/actors/npc-notes.html",
      "systems/wfrp2e/templates/actors/creature-main.html",
      "systems/wfrp2e/templates/actors/creature-notes.html",
      "systems/wfrp2e/templates/actors/creature-main.html",
      "systems/wfrp2e/templates/chat/dialog-constant.html",
      "systems/wfrp2e/templates/chat/test-card.html",
      "systems/wfrp2e/templates/chat/chat-command-display-info.html",
