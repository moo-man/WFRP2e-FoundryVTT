...
class MarketWfrp2e {
    ...
    static testForAvailability({settlement, rarity, modifier}) {
        //This method read the table WFRP2E.availabilityTable defined in the config file

        //First we get the different settlements size
        let validSettlements = Object.getOwnPropertyNames(WFRP2E.availabilityTable);
        ...
        if (settlement && validSettlementsLocalized.hasOwnProperty(settlement)) {
            let validRarity = Object.getOwnPropertyNames(WFRP2E.availabilityTable[validSettlementsLocalized[settlement]]);
        ...
        //Everything is ok, lets roll for availability
            ...
            let availabilityLookup = WFRP2E.availabilityTable[validSettlementsLocalized[settlement]][validRarityLocalized[rarity]];
    ...
    static generateSettlementChoice(rarity) {
        let cardData = {rarity: WFRP2E.availability[rarity]};
        renderTemplate("systems/wfrp2e/templates/chat/market-settlement.html", cardData).then(html => {
     ...
     * @param {Array} moneyItemInventory
     * @param transactionType WFRP2E.transactionType, is it a payment or an income
     */
    ...
    static generatePayCard(payRequest, player ) {
        ...
        } else //generate a card with a summary and a pay button
        {
            ...
            renderTemplate("systems/wfrp2e/templates/chat/market-pay.html", cardData).then(html => {
     ...
     * @param {WFRP2E.creditOptions} option
     */
    static generateCreditCard(creditRequest, option="EACH") {
        ...
        } else //generate a card with a summary and a receive button
        {
            ...
            else if (option.toLowerCase() ===WFRP2E.creditOptions.SPLIT.toLowerCase() ) 
            {
            ...
            else if ( option.toLowerCase() === WFRP2E.creditOptions.EACH.toLowerCase() )  
            {
            ...
            renderTemplate("systems/wfrp2e/templates/chat/market-credit.html", cardData).then(html => {
