class Migration
{
  ...
  {
    ui.notifications.notify("Beginning Migration to WFRP2E 1.0")
    ...
    ui.notifications.notify("Migration to WFRP2E 1.0 Finished")
  ...
  static migrateWeaponData(weaponData)
  {
    ...
    {
      let isMelee = WFRP2E.groupToType[weaponData.data.weaponGroup.value] == "melee"
