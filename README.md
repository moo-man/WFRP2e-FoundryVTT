...
2. Make sure the folder is named `wfrp2e`
...
- [The GM Tool Kit](https://github.com/Jagusti/fvtt-wfrp2e-gmtoolkit) - Extends to the Token HUD for more information and adds useful macros!
